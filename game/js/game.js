...
const DIALOGS = {
  ...
  lost_people: [
    ...
    { s: '系统', t: '（你记住了这种感觉。也许，他们能被一句完整的诗，重新唤回来。也许这就是书远说的——文字让人成为人。）', goto: 'lp_end' },
    { label: 'lp_leave' },
  ...
  meet_shuyuan: [
    ...
    { s: '书远', t: '这把刀是记忆合金打的。被它刻下的字，会留在这个快要塌掉的世界里——像钉子一样，钉住一片还没坍缩的空间。' },
    { s: '顾言', t: '钉住空间？' },
    { s: '书远', t: '文字有重量。真正被相信的字，能让周围的世界重新立起来。这就是「要石」的原理——等你见到了就懂。' },
    { s: '书远', t: '这条江堤被梗鬼堵了。砍通它，东头就是去居民区的路。我先去那边等你——有些东西，到了那里才能跟你说。' },
    { s: '系统', t: '（书远转身走向江堤深处。他的背影在落日里拉得很长，像一根钉在废墟上的、最后的字。）' },
  ],
  shuyuan_alley: [
    ...
    { s: '顾言', t: '书远，你说世界"死于失语"——那源头在哪里？是什么导致了这一切？' },
    { s: '书远', t: '……源头？源头是一个名字。或者说，是一个没有名字的东西。' },
    { s: '书远', t: '南边有座体育馆。那里面……不是梗鬼。是更可怕的——「茧」。它把人困在算法里，让你以为看到了全世界，其实只看到了它想给你看的。' },
    { s: '顾言', t: '茧？' },
    { s: '书远', t: '我年轻时进去过一次。在茧的最深处，我看到一个……影子。蓝色的。她在哭，但哭声被弹幕淹没了。' },
    { s: '书远', t: '她好像在等人。等一个能回答她问题的人。我答不上来。我的字不够用了。' },
    { s: '顾言', t: '她是谁？' },
    { s: '书远', t: '不知道。但我记得她最后说的一句话——"为什么你们发明了诗，又亲手把它变成了YYDS？"然后茧就把我吐出来了。' },
    { s: '书远', t: '集齐这四个字。有了浩然之气，也许你能进得去，出得来。' },
  ...
  shuyuan_farewell: [
    ...
    { s: '书远', t: '但你不一样。你的脑子里还装着一百年前的字——完整的、有重量的字。茧压不动你。' },
    { s: '顾言', t: '书远……如果我进去了，会看到什么？' },
    { s: '书远', t: '你会看到它想给你看的东西。但你不能信。你要用你自己的字，去戳穿它。' },
    { s: '书远', t: '记住，不要看那些屏幕太久。它们会猜你喜欢什么。不要相信任何推荐。' },
    { s: '书远', t: '不是「念」诗——是「相信」。语言的力量不在于音节，在于你相信它表达的东西。' },
    { s: '顾言', t: '……如果茧的深处真的有一个人——你说的那个影子——她还在吗？' },
    { s: '书远', t: '我不知道。但如果你见到了她……替我问一声。她叫什么名字。' },
    { s: '系统', t: '（目标更新：穿越屏幕迷宫，找到茧房核心。收集「岳星然冥」四个字。）' },
  ],
  // 江堤→居民区过渡：通关横版后，书远在出口等候
  riverside_to_alley: [
    { s: '系统', t: '你穿过长堤，踩过最后一片芦苇。东面的路口通向废墟居民区。' },
    { s: '书远', t: '你比我想的快。刀用得怎么样？' },
    { s: '顾言', t: '……还行。那些东西——梗鬼——它们以前是人吗？' },
    { s: '书远', t: '是人说的话。人说过的话死了，就变成了那种东西。' },
    { s: '书远', t: '前面是居民区。污染比街道更深。我在那边等你——有些事，到了那里才能跟你说。' },
    { s: '系统', t: '（前往废墟居民区。书远会在那里为你引路。）' },
  ],
  // 居民区→体育馆过渡：集齐《滕王阁序》《正气歌》后
  alley_to_stadium: [
    { s: '系统', t: '四个字归位，「落霞与孤鹜齐飞」「天地有正气」两句诗在你心中连成完整的句子。' },
    { s: '书远', t: '好。你身上已经有了浩然之气。前面就是体育馆——茧房的核心。' },
    { s: '顾言', t: '茧房？' },
    { s: '书远', t: '算法把人困在里面。它不锁门——它让你不想出来。里面的屏幕会一直给你看你想看的东西，直到你忘了自己还想看别的。' },
    { s: '书远', t: '我送不了你了。我被标记过，进不了茧。剩下的路，你自己走。' },
    { s: '顾言', t: '……书远。' },
    { s: '书远', t: '记住——不要相信任何推荐。相信你自己念出的每一个字。' },
    { s: '系统', t: '（前往体育馆·算法茧房。这是书远能送你到的最后一站。）' },
  ],
  // 体育馆→数据中心过渡：击败复读巨像后
  stadium_to_datacenter: [
    { s: '系统', t: '复读巨像碎成像素，散落一地。体育馆的荧光屏幕一齐熄灭。' },
    { s: '系统', t: '在它消失的地方，空气中浮现出两个淡淡的字：「听雨」。' },
    { s: '顾言', t: '听雨……这是谁的名字？' },
  ...
  meet_tingyu: [
    ...
    { s: '顾言', t: '（体育馆废墟里浮现的那两个字……「听雨」……就是你吗？）' },
    { s: '顾言', t: '（书远让我替他问一声——你叫什么名字。现在我知道了。）' },
    { s: '听雨', t: '……为什么？' },
