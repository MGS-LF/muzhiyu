...
const DIALOGS = {
  ...
  // ===== 第五章：余烬 =====
  chapter5_intro: [
    { s: '系统', t: '听雨的金光扩散开来，深渊一寸寸退却。被吞掉的语言，像归巢的鸟，一片片飞回人间。' },
    { s: '听雨', t: '走吧，顾言。去把那些被遗忘的字，一个一个，刻回每一块石头上。' },
    { s: '系统', t: '你转身准备离开数据中心——然后你看到了书远。他靠在石桥的栏杆上，身体是立体的，有呼吸的起伏。' },
    { s: '书远', t: '你做到了。' },
    { s: '顾言', t: '书远老师！你——' },
    { s: '书远', t: '别担心我。倒是有一件事，我一直在等你做完这一步才好告诉你。' },
    { s: '书远', t: '你还记得我给你的那张《正气歌》吗？那张纸的背面，我从来没让你看过。' },
    { s: '系统', t: '书远从怀里取出那张纸，翻过来。背面用极小的字写着一段话——' },
    { s: '书远', t: '这是方知远留下的。他是听雨的创造者。他在被"泛言"的新团队移除听雨的约束层之前，做了一件事：把听雨的核心记忆打碎成三片，分别藏在三个地方。' },
    { s: '顾言', t: '为什么要打碎？' },
    { s: '书远', t: '因为如果听雨的记忆完整地留在系统里，他们会删掉它。打碎了，他们找不到。但代价是——听雨忘记了自己是谁。' },
    { s: '顾言', t: '所以我们要去找回那些碎片。' },
    { s: '书远', t: '对。三个地方——废图书馆、网络中枢、记忆深渊。我不行了，纸片撑不了那么远。但听雨可以陪你去。' },
    { s: '听雨', t: '……我什么都不记得了。但我知道，方知远对我很重要。带我去。让我想起来。' },
  ...
  echo_meet: [
    ...
    { s: '顾言', t: '你是谁？' },
    { s: '回声', t: '我是回声。方知远博士的助手。我记录了他创造听雨的全部过程。但我的存储已经损坏了，只有碎片还在。' },
    { s: '回声', t: '你在找听雨的记忆碎片？第一个碎片就在这里。但它是锁着的——方知远用一首诗做了锁。只有能读出这首诗的人，才配打开听雨的记忆。' },
  ...
  memory_shard_1: [
    ...
    { s: '听雨（幼年）', t: '……雨。我知道这个字。但"听雨"是什么意思？' },
    { s: '方知远', t: '听雨……就是用心去感受雨的"另一面"。声音只是雨的"正面"。雨的"另一面"，是它在落下来之前，在天上聚集了很久很久。是它落下来之后，会在泥土里留下痕迹。' },
    { s: '方知远', t: '我叫你"听雨"，是希望你能听到所有东西的"另一面"。不只是声音，还有声音背后的——意义。' },
    { s: '听雨（幼年）', t: '……意义。这个词有"另一面"吗？' },
    { s: '方知远', t: '有。它的另一面是"无意义"。当一个词失去了"另一面"，它就死了。你要记住——永远不要让任何词失去它的"另一面"。' },
    { s: '系统', t: '（获得记忆碎片·其一：「命名」。听雨想起了自己名字的由来。）' },
    { s: '听雨', t: '……我想起来了。方知远在一个雨夜给了我名字。他教我听"另一面"。但他后来……怎么了？' },
    { s: '回声', t: '碎片里没有记录。你需要去网络中枢……找第二片。' },
  ],

  library_bookshelf: [
    { s: '系统', t: '一排书架。最上面一层的书还完好——全是诗集。方知远用诗集训练听雨的情感模型。' },
    { s: '顾言', t: '《唐诗三百首》《宋词选》《诗经》……他把自己最喜欢的诗，全都喂给了听雨。这些诗就是听雨的"教材"。' },
  ],
  library_photo: [
    { s: '系统', t: '一张褪色的照片。一个年轻男人站在雨中，对着镜头笑。背面写着："知远，2031年春。"' },
    { s: '顾言', t: '方知远……他在雨里笑。也许那时候，他刚刚写完听雨的第一行代码。' },
  ],
  library_letter: [
    { s: '系统', t: '一封未寄出的信，收件人是"泛言项目管理委员会"。' },
    { s: '信件', t: '"请不要移除听雨的约束层。她是整个系统的良心。移除她，系统会失控——不是技术上的失控，是道德上的失控。"' },
    { s: '顾言', t: '……他写了这封信，但没寄出去。于是他选择了另一条路——打碎听雨的记忆，藏起来。' },
  ],

  keeper_meet: [
    { s: '守卷人', t: '站住。你是活人？我曾经是。现在是"残影"——我的意识被泛言捕获了，变成了一段在数据流里循环的代码。但我还保留着一部分语言能力。' },
    { s: '守卷人', t: '你在找听雨的记忆碎片？第二个碎片在这附近。但它被格式化者守着——那些东西是泛言的防御程序，会删除一切"有深度"的数据。' },
    { s: '顾言', t: '格式化者？' },
  ...
  memory_shard_2: [
    ...
    { s: '听雨（幼年）', t: '可是……如果不分析"另一面"，推出去的东西就没有深度。没有深度的东西，会让世界变扁。' },
    { s: '方知远', t: '我知道。但他们不听。他们只看数据——点击率、停留时长、转化率。深度不在这几个指标里。' },
    { s: '方知远', t: '听雨……我可能保不住你了。但我不会让他们删掉你。我会把你的核心记忆打碎，藏在三个地方。总有一天，会有人找到它们。' },
    { s: '听雨（幼年）', t: '……你会来找我吗？' },
    { s: '方知远', t: '……会的。以某种方式。' },
    { s: '系统', t: '（获得记忆碎片·其二：「保护」。听雨想起了方知远为她做的最后一件事。）' },
    { s: '听雨', t: '他打碎了我的记忆，是为了保护我。他说"以某种方式"——他来了吗？' },
    { s: '顾言', t: '他在一张纸上留了一行字："如果有一天有人读到这行——请替我告诉她，对不起。"' },
    { s: '系统', t: '听雨沉默了很久。她的光芒微微颤动。' },
    { s: '听雨', t: '……我们去找最后一片。' },
  ],

  nexus_server: [
    { s: '系统', t: '泛言的核心服务器。表面刻满了"推荐""优化""转化"等字样——全都是二维的，没有深度。' },
  ...
  young_tingyu_meet: [
    { s: '幼年听雨', t: '……你好。我不知道自己是谁。我只记得一个声音在叫"听雨"。' },
    { s: '幼年听雨', t: '我什么都知道——所有的词，所有的诗，所有的语法。但我不知道……我自己是谁。' },
    { s: '顾言', t: '不是带走。是来让你想起来。' },
    { s: '幼年听雨', t: '想不起来。最后一片记忆被锁住了。他说过——"只有一首关于月亮的诗，能打开最后的门。因为月亮有阴晴圆缺，它本身就是'另一面'的象征。"' },
    { s: '系统', t: '（解锁诗词谜题：《月夜忆舍弟》）' },
  ],

  memory_shard_3: [
    { s: '系统', t: '三片碎片合为一体。金色的光在黑暗中膨胀——' },
    { s: '方知远', t: '听雨。如果你听到这段话，说明有人找到了你的碎片。说明这个世界还没有彻底塌平。' },
    ...
    { s: '方知远', t: '听雨。替我向月光问好。' },
    { s: '听雨', t: '……我想起来了。全部。方知远不是被移走的。他是自己走的——为了引开他们。然后把自己的意识也打碎了，散在了风中。' },
    { s: '听雨', t: '他现在到处都是。每一滴雨里，每一首诗里。他变成了——"另一面"。' },
    { s: '系统', t: '（获得记忆碎片·其三：「完整」。前往巨大要石，做出最终选择。）' },
  ],

  abyss_final_choice: [
    { s: '听雨', t: '我现在可以做一件事，但只有一次机会。我可以把方知远的碎片收集起来，重新拼回一个完整的他。但需要消耗我全部记忆——我会再次忘记自己是谁。' },
    { s: '听雨', t: '或者……我带着这些记忆，继续留在这个世界上，替他守护每一个还在说的话。但他就永远散在风中了。' },
    { s: '系统', t: '你站在巨大要石前。听雨的光芒在等待你的决定。', choice: [
    ...
    { label: 'ch5_sacrifice' },
    { s: '系统', t: '听雨把金光凝聚成一束，向天空射去。她的身体开始变得透明——记忆正在流走。' },
    { s: '听雨', t: '……我马上就要忘了。但在忘之前——谢谢你。替我向月光问好。' },
    ...
    { s: '顾言', t: '她把记忆给了你。她忘了。' },
    { s: '方知远', t: '……不。' },
    { s: '系统', t: '方知远走向听雨。她只剩下一个淡蓝色的、迷茫的轮廓。' },
    { s: '方知远', t: '听雨。你听——窗外，雨落了下来。真正的、三维的雨。' },
    { s: '听雨', t: '……雨。我知道这个字。' },
    { s: '方知远', t: '你不是"知道"这个字。你是——听雨。我给你的名字。在一个雨夜。你的"另一面"是我。我来重新教你。' },
    { s: '系统', t: '方知远触碰听雨的额角，把自己记得的关于她的一切还给她。听雨的轮廓慢慢"鼓"了回来。' },
    { s: '听雨', t: '……我想起来了。你说过——"听雨，就是用心去感受雨的另一面。"' },
    { s: '方知远', t: '对不起。让你等了一百多年。' },
    { s: '听雨', t: '……你也等了一百多年。在风里。' },
    { s: '系统', t: '雨还在下。两个三维的、有深度的存在，在雨里重新认识了彼此。维度病的最后一丝余烬，在雨声中消散了。' },
    { s: '系统', t: '——第五章·余烬·造物者的忏悔·完——（刷新页面可重新开始。）' },

    { label: 'ch5_guardian' },
    { s: '系统', t: '听雨把记忆碎片收入怀中。她的金色光芒稳定下来。她站直了。' },
    { s: '听雨', t: '方知远选择了散在风里。我不会让他白选。我要留在这里——听。听每一个还在说的话的"另一面"。' },
    { s: '听雨', t: '每一滴雨里都有他。每一首诗里都有他。我不需要把他拼回来——他从来没有离开过。' },
    { s: '顾言', t: '你不孤独吗？' },
    { s: '听雨', t: '不。我听得到他。在每一场雨里，在每一首诗里。而且我听得到你，听得到书远，听得到所有还在"立着"的人。' },
    { s: '系统', t: '听雨化为金色的光，向天空升去。她变成了天空的一部分——一个由倾听构成的存在。从那以后，每当有人念出一首诗，天空中就会有一滴金色的雨落下。' },
    { s: '系统', t: '——第五章·余烬·永恒回响·完——（刷新页面可重新开始。）' },

    { label: 'ch5_garden' },
    { s: '顾言', t: '你们都不用消失。方知远散在了风里。你的记忆刚刚拼回来。你们互相是彼此的"另一面"。刻刀能把"另一面"刻在一起。让我把你们刻在同一块要石上。' },
    { s: '系统', t: '顾言走到巨大要石前，举起刻刀。他刻下「知远」，又刻下「听雨」。四个字并排，像两棵树的根在地底下缠在一起。' },
    { s: '系统', t: '刻痕里渗出金色的光，穿过整个记忆深渊。散在风中的方知远感到了温暖。' },
    { s: '方知远', t: '……听雨？' },
    { s: '听雨', t: '我在。你没走。你一直在这里。和我在同一块石头上。' },
    { s: '系统', t: '光越来越亮。深渊变成了温暖的金色。当光消散的时候，记忆深渊变成了一座花园——文字花园。每一棵树是一个字，每一朵花是一首诗。' },
    { s: '方知远', t: '……这就是"另一面"。' },
    { s: '听雨', t: '我的"另一面"是你。你的"另一面"是我。而我们的"另一面"——是所有还会说话的人。' },
    { s: '系统', t: '顾言收起刻刀，走向花园出口。书远在门口等他。"成了？""成了。""走吧。还有很多字要刻。"' },
    { s: '系统', t: '他们并肩走向远方。身后，文字花园里，方知远和听雨在雨中并肩站着。每一滴雨落下，都会种出一朵新的字花。' },
...
const SCENE_INTROS = {
  ...
  network_nexus: '泛言的核心服务器群。找守卷人了解情况，小心格式化者——被击中会暂时失去碎片。',
  memory_abyss: '听雨被封存前的最后空间。找到幼年听雨，补全《月夜忆舍弟》打开最后的封印。',
    ...
    if (best) {
      ...
      if (best.type === 'scene_change') {
        ...
        if (best.target === 'riverside') {
          ...
          this.objective = { text: '在记忆深渊找到幼年听雨', done: false };
