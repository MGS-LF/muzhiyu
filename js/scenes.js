...
export const scenes = {
  ...
  street_01: {
    ...
    interactables: [
      { id: 'back_door', x: 440, y: 40, label: '回到冷冻中心', type: 'scene_change', target: 'freeze_center', spawn: { x: 360, y: 540 } },
  ...
  riverside: {
    ...
    interactables: [
      ...
      { id: 'back_street', x: 1200, y: 1000, label: '返回废弃街道', type: 'scene_change', target: 'street_01', spawn: { x: 1200, y: 1700 } },
      { id: 'to_alley', x: 1800, y: 1000, label: '前往废墟居民区', type: 'scene_change', target: 'alley_district', spawn: { x: 200, y: 200 } },
    ],
  ...
  subway: {
    ...
    interactables: [
      // 返回地面
      { id: 'subway_exit', x: 100, y: 100, label: '回到地面', type: 'scene_change', target: 'street_01', spawn: { x: 810, y: 580 } },
      // 月台上的旧告示牌
  ...
  alley_district: {
    ...
    interactables: [
      { id: 'back_riverside', x: 440, y: 40, label: '返回江堤', type: 'scene_change', target: 'riverside', spawn: { x: 1800, y: 1000 } },
      // 书远带路对话
  ...
  house_a: {
    ...
    interactables: [
      { id: 'house_a_exit', x: 240, y: 360, label: '离开', type: 'scene_change', target: 'alley_district', spawn: { x: 700, y: 700 } },
  ...
  house_b: {
    ...
    interactables: [
      { id: 'house_b_exit', x: 240, y: 360, label: '离开', type: 'scene_change', target: 'alley_district', spawn: { x: 1100, y: 700 } },
    ],
  ...
  stadium: {
    ...
    enemies: [
      { id: 'stadium_geng_1', typeId: 'geng_elite', x: 900, y: 700, hp: 100, maxHp: 100, name: '梗鬼精英' },
      { id: 'stadium_geng_2', typeId: 'geng_elite', x: 1600, y: 1000, hp: 100, maxHp: 100, name: '梗鬼精英' },
    ],

    interactables: [
      { id: 'back_alley', x: 440, y: 40, label: '返回居民区', type: 'scene_change', target: 'alley_district', spawn: { x: 1200, y: 1700 } },
      // 书远送别
      ...
      // 前往数据中心
      { id: 'to_datacenter', x: 1000, y: 1950, label: '前往数据中心', type: 'scene_change', target: 'data_center', spawn: { x: 700, y: 100 } },
    ],
  ...
  data_center: {
    ...
    interactables: [
      { id: 'back_stadium', x: 700, y: 40, label: '返回体育馆', type: 'scene_change', target: 'stadium', spawn: { x: 1000, y: 1900 } },
