...
// dialogCond: 对话播放条件（需某 flag 为 true）
// flag: 切换后设置的 flag
// objective: 切换后的目标文案
export const SCENE_TRANSITIONS = {
  ...
  subway: {
    ...
    dialog: 'subway_depth_return',
    dialogCond: 'subway_depth_log_read',
    dialogOnceFlag: 'subway_depth_returned',
    flag: 'subway_depth_returned',
  },
  alley_district: {
  ...
  subway_depth: {
    objective: '在检修通道深处寻找站长日志',
    dialog: 'subway_depth_enter',
    dialogOnceFlag: 'subway_depth_entered',
    flag: 'subway_depth_entered',
  },
};
