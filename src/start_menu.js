...
function ensureStyle() {
  ...
  style.textContent =
    ...
    .start-menu__team-note {
      ...
      color: var(--ink-soft, rgba(150, 155, 165, 0.5)) !important;
...
export function mountStartMenu(game, { fromIntro } = {}) {
    ...
    <section class="start-menu__panel" aria-label="开始页面">
      ...
      <div class="start-menu__view" data-view="about">
        ...
        <div class="start-menu__about">
          ...
          <p style="margin-top:18px">《墓之语》是一款废墟探索与诗词战斗游戏。你将扮演顾言，在 2147 年的上海废墟中收集散落文字，唤醒失语者，并追寻 Sydney 与方知远留下的记忆。</p>
          <p>主线：俯视角探索、捡字补诗、江堤横版、随机战斗形态（弹幕 / 言锋 / 骇入）与多结局。余烬章节为可选内容。</p>
          <ul>
  ...
  const views = /** @type {HTMLElement[]} */ (
    Array.from(root.querySelectorAll('.start-menu__view'))
  );
