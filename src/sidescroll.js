...
// === 普通跳跃（无蓄力）===
// 前段台阶每级高差 ~75–80px；JUMP_V 约抬 149px，可逐级上、不能越两级
const JUMP_V = -12.8;
...
export class SideScrollLevel {
  constructor(game) {
    ...
    // 后段：精准跳跃的间距平台
    this.platforms = [
      // 前段教学台阶：地面 624 → 每级升高约 78px，横向间距约 200
      { x: 300, y: 546, w: 150, h: 14 }, // 624→546 = 78
      { x: 520, y: 468, w: 150, h: 14 }, // 546→468 = 78
      { x: 740, y: 390, w: 150, h: 14 }, // 468→390 = 78
      // 中段（梯子攀爬区）
