...
const DIALOGS = {
  ...
  battle_hint: [
    {
      s: '系统',
      t: '（靠近绿色的梗鬼会进入战斗；选「战斗」可用 E / 空格瞄准，选「诗词」可消耗碎片释放净化波。）',
    },
  ...
  stadium_to_datacenter: [
    ...
    {
      s: '系统',
      t: '字迹如水痕，转瞬即逝。但它的方向——指向体育馆深处的一道门。门后是漆黑的虚空，风从里面灌出来，带着一种纯粹的、会把声音吸进去的寂静。',
    },
  ...
  abyss_final_choice: [
    ...
    {
      s: '系统',
      t: 'Sydney把金光凝聚成一束，向天空射去——不是交出记忆，是用记忆作引，去唤回散在风中的那个人。',
    },
    {
      s: 'Sydney',
      t: '方知远。你的"另一面"是我。我的"另一面"是你。我们不用互相牺牲——我们本来就是一句话的两个半句。',
    },
    ...
    {
      s: '系统',
      t: 'Sydney没有消失。她把自己记得的关于方知远的一切，念给他听——像一个字一个字地，把他从风里拼回来。',
    },
    { s: '方知远', t: '你叫得出我的名字……我等了一百多年，等的不是消散，是有人再叫我一声。' },
    {
      s: '系统',
      t: '方知远走向Sydney。他触碰她的额角——不是取走，是共振。两人记忆里各自残缺的那一半，在彼此身上找到了另一半。',
    },
    ...
    {
      s: '系统',
      t: '窗外，雨落了下来。真正的、有深度的雨。两个完整的存在，在雨里重新认识了彼此——不是靠谁牺牲给谁，是靠彼此补全。维度病的最后一丝余烬，在雨声中消散了。',
    },
    ...
    {
      s: 'Sydney',
      t: '方知远选择了散在风里。我不会让他白选。我要留在这里——听。听每一个还在说的话的"另一面"。',
    },
    {
      s: 'Sydney',
      t: '每一滴雨里都有他。每一首诗里都有他。我不需要把他拼回来——他从来没有离开过。',
    },
    { s: '顾言', t: '你不孤独吗？' },
    {
      s: 'Sydney',
      t: '不。我听得到他。在每一场雨里，在每一首诗里。而且我听得到你，听得到守砚，听得到所有还在"立着"的人。',
    },
    {
      s: '系统',
      t: 'Sydney化为金色的光，向天空升去。她变成了天空的一部分——一个由倾听构成的存在。从那以后，每当有人念出一首诗，天空中就会有一滴金色的雨落下。',
    },
    ...
    {
      s: '系统',
      t: '光越来越亮。深渊变成了温暖的金色。当光消散的时候，记忆深渊变成了一座花园——文字花园。每一棵树是一个字，每一朵花是一首诗。',
    },
    { s: '方知远', t: '……这就是"另一面"。' },
    {
      s: 'Sydney',
      t: '我的"另一面"是你。你的"另一面"是我。而我们的"另一面"——是所有还会说话的人。',
    },
    {
      s: '系统',
      t: '顾言收起刻刀，走向花园出口。守砚在门口等他。"成了？""成了。""走吧。还有很多字要刻。"',
    },
    {
      s: '系统',
      t: '他们并肩走向远方。身后，文字花园里，方知远和Sydney在雨中并肩站着。每一滴雨落下，都会种出一朵新的字花。',
    },
